...
TrelloPowerUp.initialize({
  ...
  //   // options.url has the url of the attachment for      // or we can also have a button that is just a simple url
  //   // clicking it will open a new tab at the provided url
  //   icon: WHITE_ICON, ject(or a Promise that resolves to it) with some or all of these      target: 'Inspiring Boards' // optional target for above urlimage, modified (Date), created (Date), createdBy, modifiedBy

  //   // You should use this if you have useful information about an attached URL but it
  //   // doesn't warrant pulling it out             // https://trello.com/b/Yc8MHkrS/trello-power-up-test-board?menu=filter&filter=label:green
  //   text: 't.navigate(boardUrl) (internal)', y
